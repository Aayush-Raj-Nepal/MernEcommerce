                ...
                <div class="order-placed-dt">
                  ...
                  <div class="delivery-address-bg">
                    ...
                    <ul class="address-placed-dt1">
                      <li>
                        <p>
                          <i class="uil uil-map-marker-alt"></i>Address :
                          <span>
                            #000, St 8, Sks Nagar, Near Pakhowal Road, Ldh,
                            141001
                          </span>
                        </p>
                      </li>
                      <li>
                        <p>
                          <i class="uil uil-phone-alt"></i>Phone Number :
                      ...
                      <li>
                        <p>
                          <i class="uil uil-card-atm"></i>Payment Method :
                    ...
                    <div class="stay-invoice">
                      ...
                      <a class="invc-link hover-btn">invoice</a>
                    </div>
                    <div class="placed-bottom-dt">
                      The payment of <span>$16</span> you'll make when the
                      deliver arrives with your order.
                    </div>
                  </div>
                </div>
              </div>
