                        ...
                        <div className="cart-text">
                          ...
                          <div className="qty-group">
                            <div className="edit-no">
                              <button className="edit-btn1" onClick={()=>handlecount(null,'-')}><i className="fa fa-minus" ></i></button>
							  <input style={{maxWidth:"25px",textAlign:'center', border: '2px solid #21a1d2'}} type="text" onChange={handlecount} value={count} />
							  <button className="edit-btn2" onClick={()=>handlecount(null,'+')} ><i className="fa fa-plus"></i></button>
                            </div>
                          </div>
