      ...
      axios
        ...
        .then((resp) => {
          if (resp.error_message) {
            ...
            swal
              .fire(
                "A email verification link has been sent to you google account, please verify it "
              )
              .then((a) => {
                    ...
                    <div className="form-group pos_rel">
                      ...
                      <i
                        className={
                          ...
                          " lgn_icon_right text-secondary"
                        }
                        onClick={() => setSeePassword(!seePassword)}
                      ></i>
                    </div>
                    <button className="login-btn hover-btn" onClick={signup}>
                      Sign Up Now
                    </button>
                  </div>
                  <hr></hr>
