						...
						<div className="default_tabs">
							<nav>
								<div className="nav nav-tabs tab_default  justify-content-center">
									<a className="nav-item nav-link active" href="about_us.html">About</a>
									<a className="nav-item nav-link" href="our_blog.html">Blog</a>
								...
								<div className="item">
									<div className="team-item">
										...
										<ul className="team-social">
											<li><a href="#" className="scl-btn hover-btn"><i className="fab fa-facebook-f"></i></a></li>
											<li><a href="#" className="scl-btn hover-btn"><i className="fab fa-linkedin-in"></i></a></li>
										</ul>
									</div>
								</div>
								<div className="item">
